...
>Nota: Me gustaría agregar que ``slice`` no sobrescribe por que para hacerlo hay que declarar una variable para depositar lo que vayamos a fragmentar"
...
> Aquí la aclaración de la nota anterior!
...
>Misma anotación que arriba, se crean a partir de que se declara en una variable, por eso no modifica la lista actual.
